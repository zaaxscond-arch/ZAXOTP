# config.py - Konfigurasi tools

VERSION = "3.1"
TOOLS_NAME = "ZAXOTP"

# Kode akses (sudah di database.py)
...
USER_AGENTS = [
    ...
    "Mozilla/5.0 (Linux; Android 11; SM-G991B) AppleWebKit/537.36 Chrome/119.0.0.0",
]
