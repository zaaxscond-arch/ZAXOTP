#!/usr/bin/env python3
# run.py - Main entry (kode akses disembunyikan)
...
def show_activation_menu(device_id):
    ...
    print()
    print(f"{Fore.WHITE}Masukkan kode akses yang didapat dari channel:{Style.RESET_ALL}")
    print()
...
def show_buy_guide(device_id):
    ...
    print(f"  {Fore.RED}• Owner   : Kode khusus dari admin{Style.RESET_ALL}")
    print(f"  {Fore.BLUE}• Admin   : Kode khusus dari admin{Style.RESET_ALL}")
    print(f"  {Fore.GREEN}• Premium : Kode khusus dari admin{Style.RESET_ALL}")
    print()
